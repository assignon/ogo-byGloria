<template>
  <div class="signin-core animated" id="loginModal">
    <v-layout column justify-center align-center class="login-form-layout">
      <v-flex xs10 sm10 md10 lg10 xlg10 class="close-flex"
        ><v-icon
          class="pa-3 close"
          @click="
            $store.commit('hideModal', { modalId: 'loginModal', top: '-400px' })
          "
          >fas fa-times</v-icon
        ></v-flex
      >
      <v-flex xs10 sm10 md10 lg10 xlg10 class="password-forgot-flex">
        <div class="return-cotainer pl-3">
          <v-icon class="" large @click="backToLogin()"
      ...
      <v-flex xs10 sm10 md10 lg10 xlg10 class="login-form-flex animated">
        ...
        >
          ...
          <router-link
            to="/signup"
            style="color: #2962FF;font-size: 15px; cursor: pointer;"
