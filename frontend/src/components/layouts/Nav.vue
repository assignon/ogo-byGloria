<template>
    <div class="navbar">
        ...
        <v-layout column justify-center align-center class="nav-layout hidden-sm-and-down">
            <v-flex xs12 sm12 m12 lg12 class="social-flex">
                ...
                <div class="sign ml-3 mr-3 mt-3">
                    <router-link to="/signup" style="text-decoration: none;" v-if="!$session.get('auth')"><p class="signup pl-4 pr-4 pt-1 pb-1 mr-2 font-weight-bold">
                        S'INSCRIR
                    </p></router-link>
        ...
        <v-layout row justify-space-around align-center style="z-index: 10;" class="scroll-nav-layout hidden-sm-and-down animated">
            ...
            <v-flex sm4 md3 ld3 xl3 class="sign-flex" style="">
                    <router-link to="/signup" style="text-decoration: none;" v-if="!$session.get('auth')"><p class="signup pl-4 pr-4 pt-1 pb-1 font-weight-bold">
                        S'INSCRIR
                    </p></router-link>
                    <p class="signin pl-4 pr-4 pt-1 pb-1 font-weight-bold" v-if="!$session.get('auth')" @click="$store.commit('showModal', {modalId:'loginModal',top: '100px'})">SE CONNECTER</p>
        ...
        <!-- mobile, tablete menu -->
        <v-layout row justify-space-around align-center class="mobile-menu-layout hidden-md-and-up animated fadeIn">
            <v-flex xs9 md9 class="burgermenu-flex">
                <v-icon @click.stop="drawer = !drawer" class="" style="color: #333333;margin-left:20px;" medium>fas fa-bars</v-icon>
                <h2 class="ml-3 font-weight-bold" style="color: #FB8C00;font-style: italic;">Ogo By Gloria</h2>
            </v-flex>
...
.mobile-sign-flex .signup:hover, .mobile-sign-flex .signup:hover{
    transform: scale(0.9,0.9);
}

.mobile-sign-flex .signin:hover, .mobile-sign-flex .signin:hover{
    transform: scale(0.9,0.9);
}
